package com.yogo.book.springboot.web.domain.posts;
...
/*
    (1) @After
        ...
        - 여러 테스트가 동시에 수행되면 테스트용 DB인 H2에 데이터가 그대로 남아 있어 다음 테스트 실행 시 테스트 실패할 수 있음
    (2) postsRepositoy.save
