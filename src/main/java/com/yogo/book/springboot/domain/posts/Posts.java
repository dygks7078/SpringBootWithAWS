package com.yogo.book.springboot.domain.posts;

import com.yogo.book.springboot.domain.BaseTimeEntity;
...
/*
   ...
   (3) @GeneratedValue
            ...
            - 2.0 버전과 1.5 버전의 차이는 https://jojoldu.tistory.com/295 에 정리되어 있다.
   (4) @Column
